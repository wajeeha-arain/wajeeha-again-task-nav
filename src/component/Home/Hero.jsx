...
<div className="max-w-[1440px] w-full mx-auto">
      <div className="flex justify-between bg-[#F1F1F2] items-center  md:flex-row flex-col ">
        <div className="  h-full md:w-1/2 w-full">
          <div className="md:max-w-[60%] max-w-full w-full mx-auto md:px-0 px-8 md:py-0 py-14 max-lg:justify-center  max-lg:py-6 flex-wrap  max-lg:w-[70%]">
            <h1 className="lg:text-6xl font-semibold md:text-3xl text-2xl  max-lg:text-3xl  ">
              Find a gift for your wife or girlfriend
            </h1>

            <p className="lg:text-lg md:text-base text-sm mb-5 pt-12 pb-8 pr-2 max-lg:text-start max-lg:py-6">
      ...
      <div className="flex justify-between bg-[#F1F1F2] items-center bg-primary  md:flex-row flex-col-reverse">
        ...
        <div className="md:w-1/2 w-full">
          <div className="md:max-w-[70%] max-w-full w-full mx-auto md:px-0 px-8 md:py-0 py-14 max-lg:w-[70%] max-lg:py-6 ">
            <h1 className="lg:text-5xl font-semibold md:text-3xl text-2xl leading-7 ">
            How we work
            </h1>

            <p className="llg:text-lg md:text-base mb-5 pt-8 pb-4 md:py-4 max-lg:pt-6 text-sm">
