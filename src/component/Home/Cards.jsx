    ...
    <div>
      <div className=' pt-20 max-w-[1440px] w-full mx-auto pb-40 '>
        ...
        <div className='flex justify-center items-center  gap-5 flex-wrap'>
          <div className='box-shadow min-h-120 max-h-140 w-70 bg-stone-100 hover:bg-white hover: rounded-l-lg'>
          ...
          <div className='box-shadow min-h-120 max-h-140 w-70 bg-stone-100 hover:bg-white rounded-l-lg'>
          ...
          <div className='box-shadow min-h-120 max-h-140 w-70 bg-stone-100 hover:bg-white hover:shadow-stone-200 rounded-l-lg'>
