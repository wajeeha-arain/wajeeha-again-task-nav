    ...
    <div>
      <div className=' pt-20 max-w-[1440px] w-full mx-auto pb-40 '>
        ...
        <div className='flex justify-center items-center  gap-5 flex-wrap'>
          <div className='box-shadow min-h-120 max-h-140 w-70 bg-[#FAFAFA] hover:bg-white hover: rounded-l-lg'>
            <img className=' w-70' src="https://giftstore.netlify.app/assets/images/card4.png" alt="" />
          <div className='flex-row justify-around max-h-40 w-40 mx-6 my-4 text-[14px]'>
          <p className='font-semibold pb-12  '>Birthday</p>
          <p className='pt-8 font-thin text-1'>See More</p>
          </div>
          </div>
          <div className='box-shadow min-h-120 max-h-140 w-70 bg-[#FAFAFA] hover:bg-white rounded-l-lg'>
            <img className=' w-70' src="https://giftstore.netlify.app/assets/images/card3.png" alt="" />
          <div className=' flex-row justify-around max-h-30 w-40 mx-6 my-4 text-[14px]'>
          <p className='font-semibold pb-12  '>Anniversary</p>
          <p className='pt-8 font-thin text-1'>See More</p>
          </div>
          </div>
          <div className='box-shadow min-h-120 max-h-140 w-70 bg-[#FAFAFA] hover:bg-white hover:shadow-stone-200 rounded-l-lg'>
