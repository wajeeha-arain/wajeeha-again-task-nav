  ...
  return (
    <div>
      ...
      <div className='pt-20 max-w-[1440px] w-full mx-auto'>
        ...
        <div className='flex min-h-[370px] max-w-[1170px] text-center  bg-[#231F20] text-white mx-20 my-20  flex-wrap max-md:flex-col '>
           <div> <img className='' src="https://giftstore.netlify.app/assets/images/couple.png" alt="" /></div>
          <div className='px-20 py-20 max-md:text-center '>
          <p> Mr. john Doe</p>
